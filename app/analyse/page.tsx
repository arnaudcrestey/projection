...
export default function AnalysePage() {
  ...
  return (
    <PageFrame eyebrow="PROJECTION · ANALYSE">
      <section className="premium-panel p-8 md:p-12">
        <h1 className="text-2xl font-semibold md:text-4xl">Traitement de votre projection</h1>
        <p className="mt-3 max-w-2xl text-sm leading-relaxed text-slateSoft md:text-base">
          Votre réponse est consolidée pour produire une restitution claire, structurée et directement
          exploitable.
        </p>
            ...
            return (
              <div
                ...
                className={`rounded-xl border px-4 py-3 text-sm transition ${
                  done ? "border-ink bg-white text-ink shadow-subtle" : "border-mist bg-[#f8fbff] text-slateSoft"
                }`}
              >
                {label}
              </div>
